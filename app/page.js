...
export default function Home() {
  ...
  return (
    <main className="bg-white text-slate-900">
      <section className="relative overflow-hidden bg-gradient-to-r from-[#162065] via-[#3154a0] to-[#95c0ff] py-20">
        ...
        <div className="relative mx-auto flex max-w-5xl flex-col items-end px-6 text-right text-white">
          <h1 className="text-4xl font-semibold tracking-[0.6em] drop-shadow-sm sm:text-5xl">
            {home.banner.heading}
          </h1>
      ...
      <section className="mx-auto max-w-5xl px-6 py-16">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1.5fr)_minmax(0,2fr)] lg:items-start">
          <div className="relative overflow-hidden rounded-[2.5rem] bg-slate-900 shadow-lg">
            ...
            <div className="relative flex h-full min-h-[260px] items-end justify-start p-6">
              <div className="rounded-2xl bg-white/10 px-5 py-3 text-xs font-semibold uppercase tracking-[0.35em] text-white shadow-lg shadow-black/20 backdrop-blur">
                NEOSEN
              </div>
            </div>
          </div>
          <div className="space-y-6 text-base leading-relaxed text-slate-700">
            ...
            <div className="rounded-[2.5rem] border border-slate-200 bg-slate-50 p-8 text-sm leading-relaxed text-slate-600 shadow-inner">
              <p className="text-base font-semibold text-slate-900">{home.contact.invite}</p>
